	...
	<div class="row">
		<div class="col-sm-12">
			<div class="box box-primary">
				...
				<form role="form" action="<?= base_url('admin/konfigurasi/ubahIconAksi') ;?>" method="post" enctype="multipart/form-data">
					<div class="box-body">
						...
						<div class="form-group">
							<div class="row">
								<div class="col-sm-12">
									<label for="icon">Gambar Logo</label>
								</div>
							</div>
							<div class="row" style="margin-bottom: 10px;">
								<div class="col-sm-6">
									<img src="<?= base_url('assets/img/konfig/'). $konfig['icon'] ;?>" width="100" alt="Foto Tidak Ada">		
								</div>
							</div>
							<div class="row">
								<div class="col-sm-6">
									<input type="file" name="icon" id="gambar">
